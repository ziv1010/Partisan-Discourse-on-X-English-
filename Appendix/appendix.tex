...
Table~\ref{tab:stance_distribution_keyword} presents the stance distribution (Favor, Against, Neutral) for each keyword, comparing Pro-Ruling and Pro-Opposition influencer categories. Percentages represent the proportion of tweets within each group expressing that stance.
...
\caption{Thematic Bucket Definitions} \label{tab:bucket_definitions} \\
\hline
